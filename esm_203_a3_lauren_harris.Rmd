...
**Figure 2.** Black line represents the projected average of total groundwater storage (10^9 m^3) in California from 2000 to 2050 under business as usual conditions. The initial groundwater storage level in 2000 was 350x10$^9$ m$^3$ with a standard deviation of 115x10$^9$ m$^3$. Confidence interval is 90%. Given a normal distribution, there is a 90% chance that the actual amount of groundwater in CA is between the lower limit of 190x10$^9$ m$^3$ and the upper limit of 550x10$^9$ m$^3$. Blue dashed lines show upper and lower bounds of groundwater storage. The pink box represents groundwater deficit. Data: Curmi et al. (2013)
...
Possible changes to policy include: 
 ...
 - Determining how groundwater use can be minimized agriculturally
 - Analyzing ways to increase groundwater recharge
