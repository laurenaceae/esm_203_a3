...
**Figure 1.** Predicted groundwater flow (10$^9$ m$^3$) from 2000 to 2050 in California given a business as usual scenario. Predicted net change in groundwater is equal to inputs minus outputs. Net change in groundwater will decrease by `r lm_change_per_year$coefficients[2]*-10` 10$^9$ m$^3$ every ten years. Data: Curmi et al. (2013)
