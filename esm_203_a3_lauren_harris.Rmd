...
This document analyzes the future of California's groundwater supply. Analyses are made under business as usual conditions, meaning we assume that little about water use has changed over time (assumptions listed in next section). First, the change in California groundwater from 2000 to 2050 is predicted. 

Second, the change in the total amount of groundwater is estimated under three scenarios with different levels of initial stored groundwater. Groundwater storage estimates are difficult to know without error because the only thing that can be measured is input and outputs. Inputs refer to groundwater recharge, an event which occurs when water is added to groundwater via infiltration from rain. Outputs are mainly anthropogenic, and refer to groundwater discharge, where water exits the reservoir. Examples of this include pumping water for agriculture. 

### Source of Data

Data comes from "Visualising a Stochastic Model of Californian Water
Resources Using Sankey Diagrams" by Curmi et al. (2013).
...
**Figure 2.** Red line represents the projected average of total groundwater storage (10^9 m^3) in California from 2000 to 2050 under business as usual conditions. Confidence interval is 90%. Blue dashed lines show upper and lower bounds of groundwater storage. The red box represents groundwater deficit. Data: Curmi et al. (2013)
...
- In a scenario where initial groundwater storage uses the observed value from 2000 (350x10$^9$ m$^3$), groundwater will be depleted by 2037
- In a scenario using the upper bound (550x10$^9$ m$^3$), groundwater will be depleted by 2050
